      ...
      <div class="modal key-image-modal">
        ...
        <div class="q-ma-lg">
          ...
          <template v-if="modals.key_image.type == 'Export'">
            <ItaloField class="q-mt-lg" :label="$t('fieldLabels.keyImages.exportDirectory')" disable-hover>
          ...
          <template v-if="modals.key_image.type == 'Import'">
            <ItaloField class="q-mt-lg" :label="$t('fieldLabels.keyImages.importFile')" disable-hover>
