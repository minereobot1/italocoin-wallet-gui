export default {
  ...
  menuItems: {
    ...
    exit: "Saír da Carteira GUI Italo",
  ...
  notification: {
    ...
    warnings: {
      ...
      usingRemoteNode: "italod não encontrado, utilizando nódulo remoto"
    }
  },
  placeholders: {
  ...
  strings: {
    ...
    italoBalance: "Saldo",
    italoUnlockedBalance: "Saldo desbloqueado",
    italoUnlockedShort: "Desbloqueado",
