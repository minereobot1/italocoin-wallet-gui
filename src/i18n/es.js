export default {
  ...
  menuItems: {
    ...
    exit: "Cerrar la interfaz del monedero Italo",
  ...
  notification: {
    ...
    warnings: {
      ...
      usingRemoteNode: "italod no encontrado, utilizando nodo remoto"
    }
  },
  placeholders: {
  ...
  strings: {
    ...
    italoBalance: "Saldo",
    italoUnlockedBalance: "Saldo libre",
    italoUnlockedShort: "Libre",
    ...
    serviceNodeRegistrationDescription:
      'Introduzca la orden {registerCommand} generada por el servicio (italod) que se está intentado registrar como Nodo de Servicio usando la instrucción "{prepareCommand}"',
    spendKey: "Clave de gasto",
