export default {
  ...
  fieldLabels: {
    ...
    italonetFullAddress: "ITALONET FULL ADDRESS",
  ...
  menuItems: {
    ...
    copyItalonetAddress: "Copy italonet address",
    copyItalonetName: "Copy italonet name",
    copyName: "Copy name",
  ...
  notification: {
    positive: {
      ...
      italonetAddressCopied: "Full italonet address copied",
      italonetNameCopied: "Italonet name copied",
    ...
    warnings: {
      ...
      usingRemoteNode: "italod not found, using remote node"
    }
  },
  placeholders: {
    ...
    lnsName: "The name to purchase via Italo Name Service",
    lnsBackupOwner: "The wallet address of the backup owner",
    lnsDecryptName: "A LNS name that belongs to you",
    italonetFullAddress:
      "Full italonet address to map LNS name to (without .italo)",
    ...
    sessionId: "The Session ID to link to Italo Name Service",
  ...
  strings: {
    ...
    lns: {
      sessionID: "Session ID",
      italonetName1Year: "Italonet Name 1 year",
      italonetNameXYears: "Italonet Name {years} years",
      prices: "LNS Prices:"
    },
    ...
    italoBalance: "Balance",
    italonetNameDescription:
      "Purchase or update a name on Italonet. If you purchase a name it may take a minute or two for it to show up in the list. To learn more about italonet visit: ",
    italoUnlockedBalance: "Unlocked balance",
    italoUnlockedShort: "Unlocked",
    me: "Me",
    ...
    serviceNodeContributionDescription:
      "Staking contributes to the safety of the Italo network. For your contribution, you earn ITALO. Once staked, you will have to wait either 15 or 30 days to have your Italo unlocked, depending on if a stake was unlocked by a contributor or the node was deregistered. To learn more about staking, please visit the",
  ...
  titles: {
    ...
    lnsItalonetRecords: "Italonet records",
