export default {
  ...
  notification: {
    ...
    warnings: {
      ...
      usingRemoteNode: "Не найден файл italod, используется удаленная нода"
    }
  },
  placeholders: {
  ...
  strings: {
    ...
    italoBalance: "Баланс",
    italoUnlockedBalance: "Разблокированый баланс",
    italoUnlockedShort: "Разблокировано",
