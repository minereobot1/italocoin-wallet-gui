...
async function showUpdateDialog(mainWindow) {
  ...
  const options = {
    ...
    title: "Italo Electron Wallet update available",
    message: "There is a new version of Italo Electron Wallet available.",
...
async function showCannotUpdateDialog(mainWindow) {
  const options = {
    ...
    title: "Cannot update",
    message:
      "Italo Electron Wallet failed to update but there is a new version available. Please go to https://italo.network/ and install the new version manually."
  };
